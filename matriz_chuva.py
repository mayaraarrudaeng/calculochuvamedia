...
diretorio_estacoes = 'dados/estacoes'
...
for arquivo in lista_arquivos:
	if fnmatch.fnmatch(arquivo, extensao):
		...
		if(dados.size == 0):
			print('Arquivo :', arquivo + 'nao tem dados')
			continue
...
#matriz_completa_uni.loc[ date(1966,1, 1): date(2018,7,31) ].to_csv(diretorio_resultados+'/matriz_chuva.csv')
